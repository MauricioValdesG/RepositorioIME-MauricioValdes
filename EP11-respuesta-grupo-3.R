...
setwd("/home/benja/Documentos/Universidad/2-2022/Ime/Ep11/")
datos <- read.csv2("DatosCorregidos.csv",encoding = "UTF-8")
...
# que poseen estas familias en un determinado sitio?. Cabe destacar que las regiones seleccionadas 
# corresponden a Región de Tarapacá (Zona Norte), Región del Libertador Gral. 
# Bernardo O’Higgins (Zona Centro) y Región de Los Lagos (Zona Sur).
...
#Conclusión:
# En base a los resultados obtenidos, con un 99% de confianza se puede rechazar 
# la hipótesis nula en favor de la hipótesis alternativa, por lo tanto es posible
# concluir que entre regiones del norte y sur de Chile existe una diferencia 
# significativa entre la cantidad de viviendas por sitio, pero no así el caso
# entre las regiones centrales y sur de Chile.
...
datosEnDataFrame <- dataFrameTodasLasRegiones%>% pivot_longer(c("mi_vector_T", "mi_vector_GBO", "mi_vector_LG") ,
                                names_to = "Datos")
